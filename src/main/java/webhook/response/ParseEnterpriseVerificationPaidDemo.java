...
import cn.signit.sdk.pojo.webhook.response.EnterpriseVerificationPaid;
 ...
 */
public class ParseEnterpriseVerificationPaidDemo {
    public static void main(String[] args) {

        String personVerifyWebhookRespStr = "{\"event\":\"enterpriseVerificationPaid\",\"target\":{\"webhookWsid\":\"WSID_HOOK_000001678bc29d510242ac1400030001\",\"destination\":\"https://webhook.site/dd1d048e-c07d-4f5e-bfd2-5e381eccde06\"},\"rawData\":\"{\\\"code\\\":\\\"100550000\\\",\\\"message\\\":\\\"\\\\u8BF7\\\\u6C42\\\\u6210\\\\u529F\\\",\\\"customTag\\\":\\\"hello world legal People:https://webhook.site/dd1d048e-c07d-4f5e-bfd2-5e381eccde06\\\",\\\"invokeNo\\\":\\\"201812231139168608001765203001\\\",\\\"status\\\":\\\"WAITING_SUM_CHECK\\\",\\\"description\\\":\\\"\\\\u65E0\\\",\\\"submitDatetime\\\":1545536383,\\\"handleDatetime\\\":1545746827,\\\"links\\\":[]}\",\"needCallBack\":false}";
        ...
        String signitSignature = "HmacSHA512 1678bc2091000d861138f74aa51:jNvYto5G578PUMgA2uV1XFLiSf2+w781FxqEhwsyRBxWQMMwGZwB9+qBHkEpBrr58lLJdTWG4IXMWliNt45LDg==";
        // webhook响应header中x-signit-nonce
        String nonce = "9F8jcWqwB7DQLuupq4Bvb6zE";
        // webhook响应header中x-signit-date
        String dataString = "Tue Dec 25 22:07:07 CST 2018";
        ...
        case ENTERPRISE_VERIFICATION_PAID:
            ...
            EnterpriseVerificationPaid rawData1 = (EnterpriseVerificationPaid) ente.rawDataAsBean();
            boolean s = rawData1.isSuccess();
            // 法2：
            EnterpriseVerificationPaid rawDat2 = ente.rawDataAsBean(EnterpriseVerificationPaid.class);
