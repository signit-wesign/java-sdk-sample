...
import cn.signit.sdk.pojo.webhook.response.CreateSignProcess;
 ...
 */
public class ParseCreateSignProcessDemo {
    ...
    public static void main(String[] args) {
        ...
        case ENVELOPE_STARTED:
            ...
            //CreateSignProcess rawData1 = (CreateSignProcess) ente.rawDataAsBean();
            // boolean s = rawData1.isSuccess();
            // 法2：
            CreateSignProcess rawDat2 = ente.rawDataAsBean(CreateSignProcess.class);
