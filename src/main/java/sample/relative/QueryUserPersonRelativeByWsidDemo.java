...
/**
 * 易企签 Java SDK 通过签署平台相对方个人账户id查询数据用示例代码</br>
 * 本示例代码仅展示了如何使用易企签 Java
 * SDK通过签署平台相对方个人账户id查询数据，示例代码中的id等数据均为虚拟数据，实际运行时需要根据具体需求设置相关数据</br>
 ...
 */
public class QueryUserPersonRelativeByWsidDemo {
    public static void main(String[] args) throws SignitException {
        ...
        String appUrl = "http://10.10.1.39:2576/v1/open/person-relatives/WSID_UPRE_00000186b644211a5ed9b8df90b4301d";// 测试环境使用的地址，生产环境时，应该使用上面一个appUrl
        ...
        try {
            response = client.getData(UserPersonRelativeResponse.class,new HashMap<String, String>());
