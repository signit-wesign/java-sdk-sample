...
/**
 * 易企签 Java SDK 根据第三方平台企业账户唯一ID注销对应的相对方账户用示例代码</br>
 * 本示例代码仅展示了如何使用易企签 Java
 * SDK进行根据第三方平台企业账户唯一ID注销对应的相对方账户，示例代码中的相对方账户ID数据均为虚拟数据，实际运行时需要根据具体需求设置相关数据</br>
 ...
 */
public class CancelUserEnterpriseRelativeDemo {
    public static void main(String[] args) throws SignitException {
        ...
        String appUrl = "http://10.10.1.39:2576/v1/open/organization-relatives/delete-by-third-party-user-id";// 测试环境使用的地址，生产环境时，应该使用上面一个appUrl
        ...
        // step2: 使用SDK封装请求数据
        UserEnterpriseRelativeResquest request = cancelUserPersonRelative();
        ...
        try {
            ...
            map.put("uerThirdPartyUserId","E1002");
    ...
    // 注销一个相对方企业账户
    public static UserEnterpriseRelativeResquest cancelUserPersonRelative() {
        return new UserEnterpriseRelativeResquest();
    }
