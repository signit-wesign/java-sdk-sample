...
/**
 * 易企签 Java SDK 通过第三方企业账户唯一ID查询相对方企业账户信息用示例代码</br>
 * 本示例代码仅展示了如何使用易企签 Java
 * SDK通过第三方企业账户唯一ID查询相对方1企业账户信息，示例代码中的第三方账户ID等数据均为虚拟数据，实际运行时需要根据具体需求设置相关数据</br>
 ...
 */
public class QueryUserEnterpriseRelativeDemo {
    public static void main(String[] args) throws SignitException {
        ...
        String appUrl = "http://10.10.1.39:2576/v1/open/organization-relatives/get-by-third-party-user-id";// 测试环境使用的地址，生产环境时，应该使用上面一个appUrl
        ...
        try {
            ...
            params.put("uerThirdPartyUserId","E1002");
            response = client.getData(UserEnterpriseRelativeResponse.class,params);
