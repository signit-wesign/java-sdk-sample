...
/**
 * 易企签 Java SDK 通过签署平台相对方企业账户ID修改信息用示例代码</br>
 * 本示例代码仅展示了如何使用易企签 Java
 * SDK通过签署平台相对方企业账户ID修改信息，示例代码中的企业名数据均为虚拟数据，实际运行时需要根据具体需求设置相关数据</br>
 ...
 */
public class UpdateUserEnterpriseRelativeByWsidDemo {
    public static void main(String[] args) throws SignitException {
        ...
        String appUrl = "http://10.10.1.39:2576/v1/open/organization-relatives/WSID_UERE_00000186a6bc656f5ed9b8df90b4301d";// 测试环境使用的地址，生产环境时，应该使用上面一个appUrl
