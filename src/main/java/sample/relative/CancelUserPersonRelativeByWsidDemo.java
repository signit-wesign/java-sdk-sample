...
/**
 * 易企签 Java SDK 根据签署平台相对方个人账户ID注销对应的相对方账户用示例代码</br>
 * 本示例代码仅展示了如何使用易企签 Java
 * SDK进行根据签署平台相对方个人账户ID注销对应的相对方账户，示例代码中的相对方账户ID数据均为虚拟数据，实际运行时需要根据具体需求设置相关数据</br>
 ...
 */
public class CancelUserPersonRelativeByWsidDemo {
    public static void main(String[] args) throws SignitException {
        ...
        String appUrl = "http://10.10.1.39:2576/v1/open/person-relatives/delete/WSID_UPRE_00000186a6f90b5f5ed9b8df90b4301d";// 测试环境使用的地址，生产环境时，应该使用上面一个appUrl
