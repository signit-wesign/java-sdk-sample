...
/**
 * 易企签 Java SDK 通过第三方平台企业账户唯一ID修改相对方企业账户信息用示例代码</br>
 * 本示例代码仅展示了如何使用易企签 Java
 * SDK通过第三方平台企业账户唯一ID修改相对方企业账户，示例代码中的企业名数据均为虚拟数据，实际运行时需要根据具体需求设置相关数据</br>
 ...
 */
public class UpdateUserEnterpriseRelativeDemo {
    public static void main(String[] args) throws SignitException {
        ...
        String appUrl = "http://10.10.1.39:2576/v1/open/organization-relatives/update-by-third-party-user-id";// 测试环境使用的地址，生产环境时，应该使用上面一个appUrl
        ...
        // step2: 使用SDK封装请求数据
        UserEnterpriseRelativeResquest request = updateUserEnterpriseRelative();
        ...
        try {
            ...
            map.put("uerThirdPartyUserId","E1001");
            response = client.executePut(request,map);
    ...
    // 修改相对方企业账户信息
    public static UserEnterpriseRelativeResquest updateUserEnterpriseRelative() {
        return UserEnterpriseRelativeResquest.builder()
                .uerName("测试企业呀改名二")//相对方企业名称
                .build();
    }
