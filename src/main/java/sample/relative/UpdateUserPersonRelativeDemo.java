...
/**
 * 易企签 Java SDK 通过第三方平台个人账户唯一ID修改相对方个人账户信息用示例代码</br>
 * 本示例代码仅展示了如何使用易企签 Java
 * SDK通过第三方平台个人账户唯一ID修改相对方个人账户信息，示例代码中的姓名、手机、邮箱等数据均为虚拟数据，实际运行时需要根据具体需求设置相关数据</br>
 ...
 */
public class UpdateUserPersonRelativeDemo {
    public static void main(String[] args) throws SignitException {
        ...
        String appUrl = "http://10.10.1.39:2576/v1/open/person-relatives/update-by-third-party-user-id";// 测试环境使用的地址，生产环境时，应该使用上面一个appUrl
        ...
        try {
            ...
            map.put("uprThirdPartyUserId","U1003");
    ...
    public static UserPersonRelativeResquest updateUserPersonRelative() {
        return UserPersonRelativeResquest.builder()
                .uprName("毕升华")//姓名
                .uprPhone("19900000091")//手机号
                .uprEmail("333333@qq.com")//邮箱
