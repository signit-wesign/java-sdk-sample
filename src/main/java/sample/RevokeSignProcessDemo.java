...
public class RevokeSignProcessDemo {
    ...
    public static void main(String[] args) {
        ...
        String appUrl = "http://112.44.251.136:2576/v1/open/envelopes/WSID_ENVE_00000171c600a98a0e6686044b270001/participants/WSID_EPAR_00000171c600a9cf0e6686044b270001/revoke";// 测试环境使用的地址，生产环境时，应该使用上面一个appUrl
