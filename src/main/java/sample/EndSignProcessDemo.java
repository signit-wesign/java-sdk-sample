...
public class EndSignProcessDemo {
    ...
    public static void main(String[] args) {
        ...
        // String appUrl = "https://open.signit.cn/v1/open/envelopes/{envelope-wsid}/finish";
        String appUrl = "http://112.44.251.136:2576/v1/open/envelopes/WSID_ENVE_00000163be1044920242ac1300050001/finish";// 测试环境使用的地址，生产环境时，应该使用上面一个appUrl
