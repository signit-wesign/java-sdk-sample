 ...
 */
public class EndSignProcessDemo {
    ...
    public static void main(String[] args) {
        ...
        // String appUrl =
        // "https://open.signit.cn/v1/open/envelopes/{envelope-wsid}/finish";
        String appUrl = "http://112.44.251.136:2576/v1/open/envelopes/WSID_ENVE_00000171c0838ae800ff1aa995d10001/finish";// 测试环境使用的地址，生产环境时，应该使用上面一个appUrl
        ...
        // step2: 使用SDK封装结束整个签署流程请求
        EndSignProcessRequest request = getEndSignProcessParam();
        System.out.println("request is :\n" + JSON.toJSONString(request, true));

        // step3: 执行请求,获得响应
        EndSignProcessResponse response = null;
        try {
    ...
    // 使用SDK封装结束整个签署流程请求
    private static EndSignProcessRequest getEndSignProcessParam() {
        return new EndSignProcessRequest();
    }
}
